...
here is 60 3x3 area's center coordinates selected
"""
poi_all_rounds_all=[(73, 172),(72, 169),(70, 172),(70, 169),(69, 158),
                (68, 160),(85, 166),(84, 163),(82, 161),(89, 159),
                (90, 163),(82, 163),(88, 161),(65, 171),(88, 178),
                (93, 166),(63, 182),(70, 160),(59, 166),(89, 176),
                (68, 156),(88, 171),(65, 166),(94, 161),(68, 112),
                (81, 150),(92, 173),(85, 151),(87, 159),(81, 175),
                (85, 153),(90, 161),(65, 174),(81, 170),(70, 178),
                (67, 158),(82, 167),(88, 152),(83, 139),(69, 162),
                (88, 154),(84, 114),(71, 137),(71, 175),(82, 131),
                (83, 169),(81, 114),(90, 142),(74, 169),(71, 142),
                (70, 156),(58, 154),(88, 150),(80, 146),(88, 163),
                (66, 160),(71, 163),(68, 119),(69, 135),(60, 150)]
    ...
    for trials in range (0, len(poi_all_rounds_all) ,1):
        ...
        for poi_num in range (len(poi_all_rounds_temp)):
            ...
            for trace_num in range (20000):
                ...
                temp= (( data_2D_full[trace_num,a-1, b-1] + data_2D_full[trace_num,a-1, b+0] + data_2D_full[trace_num,a-1, b+1]+
                        data_2D_full[trace_num,a+0, b-1] + data_2D_full[trace_num,a+0, b+0] + data_2D_full[trace_num,a+0, b+1]+
                        data_2D_full[trace_num,a+1, b-1] + data_2D_full[trace_num,a+1, b+0] + data_2D_full[trace_num,a+1, b+1] )/9)
